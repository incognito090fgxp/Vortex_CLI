...
def pager(items, title, columns, page_size=5, description=None):
    """
    VORTEX UI ENGINE - Universal Interactive Selector.
    
    Args:
        items (list): List of dictionaries containing the data.
        title (str): Title displayed on the top of the UI panel.
        columns (list): List of column definitions (dicts).
        page_size (int): Number of items per page.
        description (str): Optional help text shown in the footer.
    """
    current_page = 0
    cursor_pos = 0
